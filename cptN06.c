...
void ex3() {
	...
	printf("Maior Altura:\t\t%.2f S=%c", altura[maior], sexo[maior]);
	printf("Menor Altura:\t\t%.2f S=%c", altura[menor], sexo[menor]);
	printf("Media Mulheres: %.2f", mediaM);
}
